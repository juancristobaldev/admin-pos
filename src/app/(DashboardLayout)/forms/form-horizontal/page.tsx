...
import CreateBusinessForm from "@/app/components/forms/form-horizontal/BasicIcons";
...
const FormHorizontal = () => {
  return (
    <PageContainer title="Horizontal Form" description="Crea tu negocio">
      {/* breadcrumb */}
      <Breadcrumb title="Crea tu negocio" items={BCrumb} />
      {/* end breadcrumb */}
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <ParentCard title="Rellena el formulario">
            <CreateBusinessForm />
          </ParentCard>
        </Grid>
      </Grid>
